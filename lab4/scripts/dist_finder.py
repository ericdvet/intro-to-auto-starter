...
DESIRED_DIST_FROM_WALL = 0.75 # TODO: SET A DESIRED DISTANCE AWAY FROM THE WALL

WF_ZERO  = 45   # TODO: DEFINE WHAT YOUR "ZERO" ANGLE WILL BE TO FIND THE RANGE PERPENDICULAR TO THE CAR'S FORWARD VECTOR
WF_THETA = 75   # TODO: SET THETA VALUE (HINT: SHOULD BE > WF_ZERO)
...
class DistFinder:
    ...
    def scan_callback(self, data):
        ...
        #print(CD, AB, self.get_range(data, 45))
